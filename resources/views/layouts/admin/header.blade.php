<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="mobile-only-brand pull-left">
		<div class="nav-header pull-left">
			<div class="logo-wrap">
				<a href="{{ route('index') }}">
					<img class="brand-img" src="{{ asset('img/logo.png') }}" alt="brand" width="25" />
						...
						<ul class="pa-20">
							...
							<li class="col-md-6 col-xs-12 preview-carousel">
								...
								<div class="product-carousel owl-carousel owl-theme text-center">
									<a href="#">
										<img src="{{ asset('backend_assets/img/chair.jpg') }}" alt="chair">
										<span>Circle chair</span>
									</a>
									<a href="#">
										<img src="{{ asset('backend_assets/img/chair2.jpg') }}" alt="chair">
										<span>square chair</span>
									</a>
									<a href="#">
										<img src="{{ asset('backend_assets/img/chair3.jpg') }}" alt="chair">
										<span>semi circle chair</span>
									</a>
									<a href="#">
										<img src="{{ asset('backend_assets/img/chair4.jpg') }}" alt="chair">
					...
					<li>
						<div class="streamline message-nicescroll-bar">
							...
							<div class="sl-item">
								<a href="javascript:void(0)">
									<div class="sl-avatar">
										<img class="img-responsive" src="{{ asset('backend_assets/img/avatar.jpg') }}" alt="avatar"/>
									</div>
									<div class="sl-content">
			...
			<li class="dropdown auth-drp">
				<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown">
					@if(!empty(Auth::guard('admin')->user()->image))
						<img src="{{ Auth::guard('admin')->user()->imagePath }}" alt="user_auth" class="user-auth-img img-circle"/>
					@else
						<img src="{{ asset('backend_assets/img/user1.png') }}" alt="user_auth" class="user-auth-img img-circle"/>
					@endif
