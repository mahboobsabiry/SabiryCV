...
<head>
	...
	<!-- Fancy-Buttons CSS -->
	<link href="{{ asset('backend_assets/light_dist/css/fancy-buttons.css') }}" rel="stylesheet" type="text/css">
...
<body>
											...
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													...
													<div class="sl-content">
														...
														<div class="clearfix"></div>
														<span class=" truncate message-subject">  message sent via your templatemonster market profile</span>
	...
	<script src="{{ asset('backend_assets/light_dist/js/dataTables-data.js') }}"></script>
	...
	<!-- Fancy Dropdown JS -->
	<script src="{{ asset('backend_assets/light_dist/js/dropdown-bootstrap-extended.js') }}"></script>
	...
	<script src="{{ asset('backend_assets/light_dist/js/admin_script.js') }}"></script>
